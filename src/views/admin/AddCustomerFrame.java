...
public class AddCustomerFrame extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        Account account = new Account(txtUsername.getText(), String.valueOf(txtPassword.getPassword()), txtFullName.getText(), cbRole.getSelectedItem().toString(), String.valueOf(txtPhone.getText()));
